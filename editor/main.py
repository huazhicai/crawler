    ...
    def runGraph(self):
        ...
        config_data = {
            'nodes': [
                ...
                {'event_actions': {'In': 'ParseUrl'}, 'event_links': {'Out': {3: 'In'}},
                ...
                {'event_actions': {'In': 'ParseUrl'}, 'event_links': {'Out': {7: 'In'}},
                ...
                {'event_actions': {'In': 'ConsoleOutput'}, 'event_links': {}, 'inputs': {'result_any': 9},
                 'outputs': {}},
                {'event_actions': {'In': 'ConsoleOutput'}, 'event_links': {}, 'inputs': {'result_any': 3},
                 'outputs': {}},
                {'event_actions': {'In': 'ConsoleOutput'}, 'event_links': {}, 'inputs': {'result_any': 7},
                 'outputs': {}}],
            'runtime_data': [None, None, None, None, None, None, None, None, None, None,
                             'https://www.pumch.cn/doctors.html',
        ...
        self.process.start('python3', [obj_file, str(config_data)])
