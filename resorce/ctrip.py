citys_data = {'ABCDEF': {
    ...
    'B': [{
        ...
        'display': "白城",
        'data': "Baicheng|白城(DBC)|1116|DBC"
    }, {
        'display': "布尔津",
        'data': "Burqin|布尔津(KJI)|3326|KJI"
    }, {
        'display': "白山",
        'data': "Baishan|白山(NBS)|199|NBS"
    }, {
        'display': "巴彦淖尔",
    ...
    'H': [{
        ...
        'display': "霍林郭勒",
        'data': "huolinguole|霍林郭勒(HUO)|21091|HUO"
    }, {
        'display': "惠阳",
        'data': "Huiyang|惠阳(HUZ)|298|HUZ"
    }, {
        'display': "惠州",
        ...
        'display': "呼伦贝尔",
        'data': "Hulunbuir|呼伦贝尔(XRQ)|4255|XRQ"
    }],
    'J': [{
        'display': "嘉义",
        ...
        'display': "建三江",
        'data': "Jiansanjiang|建三江(JSJ)|1623|JSJ"
    }, {
        'display': "鸡西",
    ...
    'L': [{
        ...
        'display': "澜沧",
        'data': "Lancang|澜沧(JMJ)|21596|JMJ"
    }, {
        'display': "连城",
        'data': "liancheng|连城(LCX)|348|LCX"
    }, {
        'display': "龙岩",
    ...
    'M': [{
        ...
        'display': "梅县",
        'data': "Meixian|梅县(MXZ)|3053|MXZ"
    }, {
        'display': "梅州",
        'data': "Meizhou|梅州(MXZ)|3053|MXZ"
    }, {
        'display': "马公",
        'data': "Magong|马公(MZG)|5383|MZG"
    }, {
        'display': "满洲里",
    ...
    'R': [{
        ...
        'display': "若羌",
        'data': "RuoQiang|若羌(RQA)|21737|RQA"
    }],
    'S': [{
        'display': "神农架",
        ...
        'display': "石狮",
        'data': "Shishi|石狮(JJN)|406|JJN"
    }, {
        'display': "莎车",
        'data': "Shache|莎车(QSZ)|21827|QSZ"
    }, {
        'display': "上海",
        ...
        'display': "邵阳",
        'data': "Shaoyang|邵阳(WGN)|1111|WGN"
    }, {
        'display': "松原",
        'data': "Songyuan|松原(YSQ)|1303|YSQ"
    }],
    'T': [{
        'display': "台州",
        ...
        'display': "泰州",
        'data': "Taizhou|泰州(YTY)|579|YTY"
    }],
    'W': [{
        'display': "五大连池",
        'data': "Wudalianchi|五大连池(DTU)|473|DTU"
    }, {
        'display': "乌兰浩特",
        'data': "UlanHot|乌兰浩特(HLH)|484|HLH"
    }, {
        'display': "乌兰察布",
        ...
        'display': "乌拉特中旗",
        'data': "Wulatezhongqi|乌拉特中旗(WZQ)|21184|WZQ"
    }]
}, 'XYZ': {
    'X': [{
        'display': "兴义",
        ...
        'display': "香格里拉",
        'data': "Shangri-La|香格里拉(DIG)|93|DIG"
    }, {
        'display': "夏河",
    ...
    'Z': [{
        ...
        'display': "遵义茅台",
        'data': "ZunyiMaotai|遵义茅台(WMT)|669329|WMT"
    }, {
        'display': "张掖",
        'data': "ZHANGYE|张掖(YZY)|663|YZY"
    }, {
        'display': "昭通",
        'data': "ZHAOTONG|昭通(ZAT)|555|ZAT"
    }, {
        'display': "湛江",
        'data': "ZHANJIANG|湛江(ZHA)|547|ZHA"
    }, {
        'display': "中卫",
        ...
        'display': "遵义",
        'data': "ZunyiXinzhou|遵义(ZYI)|558|ZYI"
    }]
}
}
...
def get_citys(citys):
    city_list = []
    i = 1
    for item in citys.values():
        for ite in item.values():
            for index, it in enumerate(ite):
                # print(i, it['display'])
                city_list.append((i, it['display']))
                i += 1
    return city_list
...
def lines(city_list):
    ...
    for start in city_list:
        for doc in collection.find():
            # if start[1] in doc['start_station_name']:
            if doc['start_station_name'].startswith(start[1]):
                time_ = datetime.strptime(doc['arrive_time'], '%H:%M') - datetime.strptime(doc['start_time'], '%H:%M')

                for dest in city_list:
                    if dest[1] in doc['arrive_station_name']:
                    # if doc['arrive_station_name'].startswith(dest[1]):
                        line = [(start[0], dest[0]), (time_.seconds//60,)]
                        print(i, line)
                        i += 1
                        # break
...
if __name__ == '__main__':
    ...
    # test_data()
    # print(get_citys(citys_data))
    city_list = get_citys(citys_data)
    lines(city_list)
# 33164 [(261, 180), (datetime.timedelta(-1, 6600),)]